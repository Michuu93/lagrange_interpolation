...
function Lagrange(n: Integer; xx: Extended; x,y: vector):Extended;
var
  i,j: integer;
  m,l,dy: Extended;
begin
    ...
    try
      ...
      while not Eof(plik) do
        begin
          if numer>max then
            begin
              ShowMessage('Podaj maksymalnie ' + IntToStr(max) +  ' wspó³rzêdnych!');
              exit;
            end;
          ...
          try
            ...
            ShowMessage('B³¹d wczytywania wspó³rzêdnych!');
            exit;
          end;
          numer:=numer+1;
        end;
